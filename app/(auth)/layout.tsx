...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <PublicNav />
      <main className="min-h-screen bg-zinc-50 p-4 pb-10 md:p-6">
        ...
        <div className="mx-auto grid w-full max-w-6xl overflow-hidden rounded-3xl border bg-white shadow-sm md:grid-cols-2">
          <section className="relative hidden min-h-[760px] md:block">
            <img
